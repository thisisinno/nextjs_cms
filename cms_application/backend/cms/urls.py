...
urlpatterns=[path('',include(router.urls)),path('home/',home),path('admin/',include(admin_router.urls)),path('admin/settings/',admin_settings),path('admin/dashboard/',dashboard)]

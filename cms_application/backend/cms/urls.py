...
urlpatterns=[path('',include(router.urls)),path('home/',home),path('site-settings/',site_settings),path('admin/',include(admin_router.urls)),path('admin/settings/',admin_settings),path('admin/dashboard/',dashboard),path('admin/translate/',admin_translate)]
